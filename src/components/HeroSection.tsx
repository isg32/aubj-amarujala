      ...
      <div className="container relative z-10 pt-24 sm:pt-28 pb-12 sm:pb-16">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className="max-w-2xl text-center lg:text-left">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-heading font-bold text-primary-foreground leading-tight mb-1 sm:mb-2">
              Bhavishya Jyoti
            </h1>
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-heading font-bold text-accent leading-tight mb-4 sm:mb-6">
              Samman 2026
            </h1>
